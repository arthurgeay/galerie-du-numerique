...
urlpatterns = [
    ...
    path("artworks/edit/<int:id>/", views.edit_artwork, name="edit_artwork"),
    path("artworks/delete/<int:id>", views.delete_artwork, name="delete_artwork"),
    # Artists
    path("artists", views.view_artists, name="view_artists"),
    path("artists/create/", views.create_artist, name="create_artist"),
    path("artists/edit/<int:id>/", views.edit_artist, name="edit_artist"),
